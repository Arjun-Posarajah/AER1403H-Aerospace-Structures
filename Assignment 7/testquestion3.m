...
H = (0.5/total_A)*[nodes(2,2)-nodes(2,3) 0 nodes(2,3)-nodes(2,1) 0 nodes(2,1)-nodes(2,2) 0; 0 nodes(1,3)-nodes(1,2) 0 nodes(1,1)-nodes(1,3) 0 nodes(1,2)-nodes(1,1); nodes(1,3)-nodes(1,2) nodes(2,2)-nodes(2,3) nodes(1,1)-nodes(1,3) nodes(2,3)-nodes(2,1) nodes(1,2)-nodes(1,1) nodes(2,1)-nodes(2,2)];
