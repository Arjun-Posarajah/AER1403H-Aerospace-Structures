...
middle_node_index = floor((numradial / 2) * (numtheta + 1) + numtheta / 2) + 1;

% Force is applied at the middle node
...
% Check the force vector
disp('Force Vector:');
disp(applied_force_vector);

% Calculate displacement
displacement = (1 / thickness) * ((K) \ (applied_force_vector(free_dof)));

% Check the displacement vector
